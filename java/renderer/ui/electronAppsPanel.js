export class ElectronAppsPanel {
  ...
  renderApps() {
    ...
    const iconData = {
      minecraftPanel: 'data:image/svg+xml;utf8,' + encodeURIComponent(`
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
          <rect width="64" height="64" rx="14" fill="#4a7028"/>
          <rect x="14" y="16" width="36" height="30" rx="7" fill="#0b0b12"/>
          <path d="M20 24h24M20 31h24M20 38h14" stroke="#86efac" stroke-width="3" stroke-linecap="round"/>
          <rect x="42" y="38" width="8" height="8" rx="2" fill="#86efac"/>
        </svg>
      `),
