...
- Page modules: AI settings, Minecraft manager, PDF station, games, history, todo, security defense.
...
export const responseDatabase = {
  ...
  'downloads': 'Downloads now open in a dedicated tab page via `btn-nav-downloads`, with refresh/clear actions and per-item controls (open file, show folder, pause/resume/cancel).',
