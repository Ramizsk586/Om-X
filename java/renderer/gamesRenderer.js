...
document.addEventListener('DOMContentLoaded', () => {
    ...
    class GameAIAgent {
        ...
        async generateLevel(gameType, level, performance) {
            // 1. Local Fallback if no API Key or offline
            if (!this.client) {
                ...
                if (gameType === 'visual') {
                    ...
                    schema = {
                        ...
                        properties: {
                            ...
                            blurStart: { type: Type.NUMBER },
                            blurDecay: { type: Type.NUMBER },
    ...
    class BaseGame {
        ...
        gameOver(msg) {
            ...
            // Reset level for next click
            btnStart.onclick = () => {
                btnStart.onclick = null; // Remove this handler
                // Re-launch level 1
                this.score = 0;
    ...
    // --- 3. MEMORY (Simplified for length) ---
